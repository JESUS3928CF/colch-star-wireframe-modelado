...
const peticionesBackend = new PeticionesBackend(
    'http://localhost:3000/api/clientes/usuario/'
);
...
(()=>{
    ...
    function cambiarEstado(e) {
        ...
        Swal.fire({
            title: 'Estas seguro?',
            text: "Desear cambiar el estado de este usuario!",
            icon: 'warning',
...
async function cambiarEstadoBackend(registro,elemento){
    ...
    try {
        const resultado = await peticionesBackend.cambiarEstado(registro, registro.id_usuario);
